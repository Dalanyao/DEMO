...
def get_ide_tool():
    ...
    try:
        ...
        # gitee 超时
        IDE_TOOL_LINK = 'https://github.com/nbtool/all_in_one_ide_tool.git'
...
DEMO_PATH = './samples/beacon_peripheral_sample_phy6252'
DEMO_NAME = 'beacon_peripheral_sample_phy6252'
DEMO_FIRMWARE_VERSION = '1.0.0'
DEMO_OUTPUT_PATH = './_output'
BOARD_NAME = 'phy6252_adv'
