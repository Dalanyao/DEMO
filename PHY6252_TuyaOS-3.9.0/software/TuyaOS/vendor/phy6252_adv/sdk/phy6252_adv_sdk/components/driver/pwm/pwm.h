...
void hal_pwm_start_channel(PWMN_e pwmN);
void hal_pwm_stop_channel(PWMN_e pwmN);
...
void hal_pwm_set_cmp_count_val(PWMN_e pwmN, uint16_t cmpVal);
...
void hal_pwm_set_pol(PWMN_e pwmN, PWM_POLARITY_e pwmPolarity);
