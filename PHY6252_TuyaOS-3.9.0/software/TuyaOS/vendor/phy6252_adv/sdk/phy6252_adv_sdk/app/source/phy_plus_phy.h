...
#define PPP_TY_BEACON_EVT           0x0040
#define PPP_TY_AUTHORIZE_EVT        0x0080
#define PPP_RTC_TEST_EVT            0x0100
...
*/
extern void PhyPlusPhy_Init( unsigned char task_id );

/*
    Task Event Processor for the PHYPLUS PHY Application
*/
extern unsigned short PhyPlusPhy_ProcessEvent( unsigned char task_id, unsigned short events );


extern void phy_tx_buf_updata(unsigned char* txPayload,unsigned char dlen);
